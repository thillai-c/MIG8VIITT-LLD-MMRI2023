...
def main():
    ...
    cls_num_list=[31,22,19,14,17,15,68]
    ...
    if args.smoothing:
        ...
        train_loss_fn = LDAMLoss(cls_num_list=cls_num_list, max_m=0.5, s=30, weight=per_cls_weights)
    train_loss_fn = train_loss_fn.cuda()
    validate_loss_fn = LDAMLoss(cls_num_list=cls_num_list, max_m=0.5, s=30, weight=per_cls_weights).cuda()
